...
<div class="container-fluid container-xxl">
    <div class="row py-2 d-flex justify-content-between">
        ...
        <a href="{{route('admin.le-mie-aziende.edit', $agency->slug)}}" class="btn btn-warning"style="width: 53px;">
    ...
    <div class="row">
        @foreach ($agency->courses as $agency)    
            <div class="col-4" style="border: 1px solid black">
                ...
                @endif
                <a href="{{route('admin.tutti-i-corsi.show', $agency->slug)}}">Vai al corso</a>
            </div>
        @endforeach
    </div>
@endsection