...
<form action="{{route($routeName, $course)}}" method="POST" enctype="multipart/form-data" class="mt-2">
    ...
    <div class="mb-3 d-flex">
        ...
        <div class="w-50">
            ...
            <select @error('categoria') style="border: 1px solid red" @enderror class="my_form_input_categoria" {{-- class="js-example-basic-single"--}} name="categoria" id="course_categoria"> 
                <option value="" selected disabled></option>
    ...
    <div class="mb-3">
        ...
        <input @error('titolo') style="border: 1px solid red" @enderror class="my_form_input_titolo" type="text" id="coruse_titolo" name="titolo" value="{{old('titolo', $course->titolo)}}">
        @error('titolo')    
            <div class="text-danger">
                <i class="fa-solid fa-circle-exclamation pe-1"></i>{{$message}}
            </div>
    ...
    <div class="mb-3">
        ...
        <input @error('sottotitolo') style="border: 1px solid red" @enderror class="my_form_input_sottotitolo" type="text" id="course_sottotitolo" name="sottotitolo" value="{{old('sottotitolo', $course->sottotitolo)}}">
        @error('sottotitolo')    
            <div class="text-danger">
                <i class="fa-solid fa-circle-exclamation pe-1"></i>{{$message}}
            </div>
    ...
    <div class="mb-3">
        ...
        <textarea @error('descrizione') style="border: 1px solid red" @enderror class="my_form_input_descrizione" id="course_descrizione" rows="10" name="descrizione">{{old('descrizione', $course->descrizione)}}</textarea>
        @error('descrizione')    
            <div class="text-danger">
                <i class="fa-solid fa-circle-exclamation pe-1"></i>{{$message}}
            </div>
    ...
    <div class="mb-3 d-flex">
        <div class="w-50 d-flex flex-column justify-content-center position-relative">
            ...
            <label for="course_immagine" class="custom-file-upload" @error('immagine') style="border: 1px solid red; background-color: red; opacity: 0.4; color: white;" @enderror>Scegli FIle...</label>
        ...
        <div class="w-50">
            ...
            <input @error('video_corso') style="border: 1px solid red" @enderror class="my_form_input_video" type="text" id="course_video_corso" name="video_corso" value="{{old('video_corso', $course->video_corso)}}">
            @error('video_corso')    
                <div class="text-danger">
                    <i class="fa-solid fa-circle-exclamation pe-1"></i>{{$message}}
                </div>
    ...
    <div class="mb-3 d-flex justify-content-between">
        ...
        <div style="width: 26%;">
            ...
            <select @error('lingua') style="border: 1px solid red" @enderror {{-- class="js-example-basic-single"--}} class="my_form_input_lingua" name="lingua" id="course_lingua"> 
                <option value="" selected disabled></option>
    ...
    <div class="mb-3 d-flex">
        <div class="w-50">
            ...
            <textarea @error('programma') style="border: 1px solid red" @enderror class="my_form_input_programma" id="course_programma" rows="7" name="programma">{{old('programma', $course->programma)}}</textarea>
            @error('programma')    
                <div class="text-danger">
                    <i class="fa-solid fa-circle-exclamation pe-1"></i>{{$message}}
                </div>
        ...
        <div class="w-50 d-flex flex-column justify-content-evenly">
            <div class="w-100">
                ...
                <input @error('competenze_partenza') style="border: 1px solid red" @enderror class="my_form_input_cPartenza" id="course_competenze_partenza" name="competenze_partenza" value="{{old('competenze_partenza', $course->competenze_partenza)}}">
                @error('competenze_partenza')    
                    <div class="text-danger">
                        <i class="fa-solid fa-circle-exclamation pe-1"></i>{{$message}}
                    </div>
                @enderror
            ...
            <div class="w-100">
                ...
                <input @error('obiettivi') style="border: 1px solid red" @enderror class="my_form_input_obiettivi" type="text" id="course_obiettivi" name="obiettivi" value="{{old('obiettivi', $course->obiettivi)}}">
                @error('obiettivi')    
                    <div class="text-danger">
                        <i class="fa-solid fa-circle-exclamation pe-1"></i>{{$message}}
                    </div>
    ...
    <div class="mb-3 d-flex">
        <div class="w-50">
            ...
            <input @error('a_chi_si_rivolge') style="border: 1px solid red" @enderror class="my_form_input_rCorso" type="text" id="course_a_chi_si_rivolge" name="a_chi_si_rivolge" value="{{old('a_chi_si_rivolge', $course->a_chi_si_rivolge)}}">
            @error('a_chi_si_rivolge')    
                <div class="text-danger">
                    <i class="fa-solid fa-circle-exclamation pe-1"></i>{{$message}}
                </div>
            @enderror
        ...
        <div class="w-50">
            ...
            <input @error('requisiti_richiesti') style="border: 1px solid red" @enderror class="my_form_input_rRichiesti" type="text" id="course_requisiti_richiesti" name="requisiti_richiesti" value="{{old('requisiti_richiesti', $course->requisiti_richiesti)}}">
            @error('requisiti_richiesti')    
                <div class="text-danger">
                    <i class="fa-solid fa-circle-exclamation pe-1"></i>{{$message}}
                </div>
            @enderror
